...
const tryAgainMessage = ": Please try again later, otherwise " + contractOneledgerSupport;
...
const requestErrors = {
    ...
    IllegalQueryReply: {
        ...
        detail: "-10001 : domain query result is not array"
    },
    IllegalPrice: {
        code: -10002,
        message: "Invalid Price (10002): Please enter a valid price for the domain, currency and value in Price both should be string type",
